...
usersCltr.login = async(req, res) => {
    const errors = validationResult(req);
        ...
        const otpExpires = Date.now() + 300000; // 5 minutes in seconds
        ...
        try {
            ...
            await transporter.sendMail({
              ...
              Please enter this code on the login page to complete your authentication. For your security, this OTP is valid for a limited time and can be used only once.
